<x-guest-layout>
    ...
    <div class="container mx-auto mt-12 p-8 bg-white rounded-lg shadow-lg">
        <h1 class="text-4xl font-bold text-center text-gray-800" style="color: #198754">Vendedor</h1>
        <p class="mt-2 text-center text-gray-600 text-lg">Bienvenid@, {{ Auth::user()->name }}.</p>

        <!-- Enlaces para gestionar productos -->
        <div class="mt-8">
            <h2 class="text-3xl font-semibold mb-4 text-green-800" style="text-align: center">Gestión de Productos</h2>
            <ul class="mt-2 space-y-3">
                <li>
                    <a href="{{ route('vendedor.products.index') }}" class="block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500 transition duration-200 text-center">
                        Ver Productos
                    </a>
                </li>
                <li>
                    <a href="{{ route('vendedor.products.create') }}" class="block px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-500 transition duration-200 text-center">
                        Agregar Producto
                    </a>
                </li>
            </ul>
