<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="actions">
            ...
            <x-button class="bg-green-600 hover:bg-green-500 focus:bg-green-500 active:bg-green-700">
                {{ __('Create') }}
            </x-button>
        </x-slot>
    </x-form-section>
    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="mt-4 bg-green-100 px-4 py-2 rounded font-mono text-sm text-gray-500 w-full break-all"
    ...
    <x-dialog-modal wire:model.live="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-button class="ms-3 bg-green-600 hover:bg-green-500 focus:bg-green-500">
                {{ __('Save') }}
            </x-button>
        </x-slot>
    </x-dialog-modal>
